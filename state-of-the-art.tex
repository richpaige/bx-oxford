...
\begin{figure}[htbp]
\centering{\scalebox{0.6}{\includegraphics{qvt-architecture.png}}}
\label{fig:qvt}
...
\begin{figure}[htbp]
\centering{\scalebox{0.6}{\includegraphics{mapping-rule.png}}}
\label{fig:qvt-core}
